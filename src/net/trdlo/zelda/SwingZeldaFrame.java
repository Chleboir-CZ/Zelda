...
final class SwingZeldaFrame extends JFrame implements ZeldaFrame, WindowListener, InputListener, CommandExecuter {
	...
	SwingZeldaFrame(String frameCaption, GameInterface gameInterface) {
		super(frameCaption);
	...
	@Override
	public void setCursor(ZeldaCursor cursor) {
		//assert cursor instanceof SwingZeldaCursor;

		//setCursor(((SwingZeldaCursor) cursor).getSwingCursor());
	}
